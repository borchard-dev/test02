...
//======================================================================
	...
	define( "SITE_URL" , "http://3.25.82.104/" );
	# Your website URL

	define( "SRV_NAME" , "Rustralia" );
    # Server or project name, will be used as title

    define( "SRV_SLOGAN" , "Rustralia is cool" );
    # Server or project slogan, will be used as slogan and description

    define( "SRV_TWITTER" , "nope" );
...
//======================================================================
    ...
    define( "DISCORD_SERVER_ID" , "879384216624832557" );
    # Discord Server ID, Discord App -> Your Server -> Server Settings -> Widget -> Server ID

    define( "DISCORD_INVITE_LINK" , "https://discord.gg/vfE2pcgn" );
    ...
    define( "STEAM_GID" , "103582791470629985" );
	...
	define( "STORE_URL" , "http://3.25.82.104/store/" );
	# URL to your store
